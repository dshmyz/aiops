...
<template>
  <section data-test="dashboard-entry" data-view="dashboard" class="dashboard-entry">
    ...
    <section class="stat-grid" aria-label="运维统计">
      <div class="stat-card" data-test="stat-pending-plans">
      ...
      <div class="stat-card" data-test="stat-active-alerts">
      ...
      <div class="stat-card" data-test="stat-enabled-tasks">
        <span class="stat-value">{{ overview.enabled_tasks ?? 0 }}</span>
        <span class="stat-label">启用的定时巡检</span>
      </div>
      <div class="stat-card" data-test="stat-today-executions">
